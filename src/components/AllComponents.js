                            ...
                            return (
                                <div className='container' key={i}>
                                    <div className='row'>
                                        ...
                                        <div className='col-md-6'>
                                            <div>
                                                <h5 className='text-truncate fw-bold'><a target="_blank" rel="noreferrer" href={article.url} className="mtlb">{article.title}</a></h5>
                                            ...
                                            <div className=''>
                                                <p className='text-capitalize align-bottom'><span className='fw-bold'>{category}</span> / {new Date(article.publishedAt).getDate()} {new Date(article.publishedAt).toLocaleString('default', { month: 'long' })} {new Date(article.publishedAt).getFullYear()} </p>
                                            </div>
                                        </div>
                                    </div>
                                    <hr />
                                    ...
                                    <div key={i}>
                                        ...
                                        <div className="row mt-4 mb-3">
                                            <div className="col-md-7">
                                                <h5 id='ptpit'><a target="_blank" rel="noreferrer" href={element.url} className='mtlb'>{element.title.slice(0, 30)}</a></h5><br />
                                                <p className='text-muted text-capitalize'><span className='fw-bold'>{category}</span> / {new Date(element.publishedAt).getDate()} {new Date(element.publishedAt).toLocaleString('default', { month: 'long' })} {new Date(element.publishedAt).getFullYear()} </p>
                                            </div>
                                            ...
                                            <div className="row g-0">
                                                ...
                                                <div className="col-md-5">
                                                    <div className="card-body pcardb">
                                                        <h5 className="card-title tpkct fs-6"><a target="_blank" rel="noreferrer" href={elements.url} className='mtlb' style={{ width: "150px" }}>{elements.title.slice(0, 30)}</a></h5><br /><br />
                                                        <p className='card-text really-small text-capitalize'><span className='fw-bold'>{category}</span> / {new Date(elements.publishedAt).getDate()} {new Date(elements.publishedAt).toLocaleString('default', { month: 'long' })} {new Date(elements.publishedAt).getFullYear()} </p>
                                                    </div>
                                                </div>

        ...
        <div className='container'>
            <div className="row prow">
                <div className="col-8" id="left-section">
                    <h1 className='text m-3'>Hollywood</h1>
                    <hr className='bhr'/>
                    {HollywoodData.hollywoodBig.map(elements => {
                        return (
                ...
                <div className="col-4" id="right-section">
                    ...
                    <hr className='bhr'/>
                    <br />
                        {HollywoodData.hollywoodUpBig.map(element => {
                            return (
                                <>
                        ...
                        <div className="row">
                            {HollywoodData.hollywoodSmall.map(elements => {
                                return (
